...
CREATE 
    ...
    (s1)-[:SEGMENT {distance: 223.3}]->(s2),
    (s1)-[:SEGMENT {distance: 123.9}]->(s10),
    (s2)-[:SEGMENT {distance: 720.1}]->(s3),
    (s3)-[:SEGMENT {distance: 256.3}]->(s4),
    (s4)-[:SEGMENT {distance: 400.5}]->(s5),
    (s5)-[:SEGMENT {distance: 521.4}]->(s6),
    (s4)-[:SEGMENT {distance: 643.2}]->(s8),
    (s8)-[:SEGMENT {distance: 300.5}]->(s5),
    (s5)-[:SEGMENT {distance: 734.5}]->(s9),
    (s9)-[:SEGMENT {distance: 123.4}]->(s6),
    (s6)-[:SEGMENT {distance: 900.45}]->(s7),
    (s10)-[:SEGMENT {distance: 932.3}]->(s11),
